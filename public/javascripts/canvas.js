...
function init() {
	...
	labels["logo"] = new Label({x: 0.5, y: 0.3}, "Avengers-jitsu", 100, true, false, false, "ChineseTakeaway");
	labels["play"] = new Label({x: 0.5, y: 0.7}, "Play NOW!", 144, true, true, false, labelFont, enterQueue);
	labels["searching"] = new Label({x: 0.5, y: 0.7}, "Looking for opponents   ", 130, false, false, false, labelFont);
	...
	labels["timer"] = new Label({x: 0.5, y: 0.1}, 20, 64, false, false, false, "ChineseTakeaway");
}
...
var types = ["Iron Man", "Hulk", "Thor"];
var colors = {"yellow": "#361A29", "orange": "#EFA53A", "green": "#924F9E", "blue": "#CCF4FE", "red": "#D93D27", "purple": "#626EDA"};
